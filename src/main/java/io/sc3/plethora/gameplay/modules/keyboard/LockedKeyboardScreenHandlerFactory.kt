...
import io.sc3.plethora.gameplay.registry.Registration.ModScreens.LOCKED_KEYBOARD_HANDLER_TYPE
...
class LockedKeyboardScreenHandlerFactory(
  ...
  override fun createMenu(syncId: Int, inv: PlayerInventory, player: PlayerEntity): ScreenHandler =
    ComputerMenuWithoutInventory(LOCKED_KEYBOARD_HANDLER_TYPE, syncId, inv, ::canUse, computer)
  ...
  private fun canUse(player: PlayerEntity): Boolean {
    ...
    // This module doesn't have to deal with computers that have block entities, so just return true
    return true;
  }
}
